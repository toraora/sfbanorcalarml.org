...
closes at the end of day on Wednesday, May 13.

[**Order an *extra* shirt here.**](/news/season-2026/2026-extra-shirts/)

When ordering an extra shirt, please specify the color and size of your shirts
on the order form (e.g. Coach S; A1 M; Heliconia L).
...
non-elite teams, based on a number of factors including student preference. An
updated team assignment list is provided below. Note that the numbers of A3
through A6 are entirely arbitrary and do not indicate anything about team
